    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="uploads/slider/slider1.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="uploads/slider/slider2.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="uploads/slider/slider3.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="row row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="<?= BASE_URL . '?act=all-san-pham'?>">
                            <img src="uploads/1723680337sp02_51.jpg" alt="product banner">
                        </a>
                        <div class="banner-content text-right">
                            <h5 class="banner-text1">shop thú cưng</h5>
                            <h2 class="banner-text2">Sản Phẩm<span>shiba</span></h2>
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-center">
                            <h5 class="banner-text1">thú cưng</h5>
                            <h2 class="banner-text2"> <span>Chó Phú Quốc</span></h2>
                            <a href="<?= BASE_URL . '?act=all-san-pham'?>" class="btn btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-center">
                            <h5 class="banner-text1">thú cưng</h5>
                            <h2 class="banner-text2">Bộ Sưu Tập<span>Chó Poodle</span></h2>
                            <a href="<?= BASE_URL . '?act=all-san-pham'?>" class="btn btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-right">
                            <h5 class="banner-text1">thú cưng</h5>
                            <h2 class="banner-text2"><span>Chó Pug</span></h2>
                            <a href="<?= BASE_URL . '?act=all-san-pham'?>" class="btn btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
