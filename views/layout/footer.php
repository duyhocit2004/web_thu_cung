                    ...
                    <div class="widget-item">
                        <div class="widget-title">
                            <div class="widget-logo">
                                <a href="<?= BASE_URL ?>">
                                    <img src="uploads/logo/dog.png" alt="brand logo" width="60px">
                                    <img src="uploads/logo/LOGO.png" alt="brand logo" width="150px">
                                </a>
                            </div>
                        </div>
                            ...
                            <address class="contact-block">
                                <ul>
                                    ...
                                    <li><i class="pe-7s-mail"></i> <a
                                            href="mailto:nongthanthien2004@gmail.com">webthucung@gmail.com </a>
                                    </li>
                                    <li><i class="pe-7s-call"></i> <a href="tel:0369 312 858">hotline: 233333333</a></li>
                                </ul>
                            </address>
                        </div>
                    </div>
